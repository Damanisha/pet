    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content wow fadeInDown">
            <div class="modal-header">
                <h4 class="wow fadeInDown">City Dog Pound Stray Animal IMS</h4>
            </div>
            <br />
            <center><i class="fa fa-user"></i> Welcome!</center>
            <form class="form-horizontal wow fadeInDown" method="POST" action="adminlogin_process.php">
                ...
                <div class="modal-footer wow fadeInDown" style="padding-right:110px;">
                    ...
                    <button type="button" class="btn btn-success wow fadeInDown" data-toggle="modal" data-target="#signupModal" data-dismiss="modal">Sign Up</button>
                </div>
            </form>
        </div>
    </div>
