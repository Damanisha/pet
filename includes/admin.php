...
<div class="container">
   <form id="formFilter" name="formFilter" action="admin_reservefilter.php" method="POST" class="pull-left col-md-3 hidden-print">
    ...
    <a href="index.php" class="btn btn-default pull-right hidden-print wow fadeInDown" style="margin-right:10px;"><img src="images/ico/search-icon-2048x2048-cmujl7en.png" style="max-width: 20px; max-height: 20px;"> Search</a>
    <div class="col-md-12" style="border: solid #D9D9D9 1px; padding: 10px; padding-top: 5px; box-shadow: #9F9F9F 2px 3px 5px; margin-top: 10px;">
        ...
        <table class="table table-hover table-condensed wow fadeInDown">
            <thead style="background-color:#282828; color:#fff;">
                <tr>
                    <th class="hidden-print" style="text-align:center;"> <span></span> Breed</th>
                    <th width="120px" style="text-align:center;"><span class="glyphicon glyphicon-user"></span> Gender </th>
                    <th style="text-align:center;"><span class="glyphicon glyphicon-gift"></span>  Product </th>
                    <th style="text-align:center;"><span class="glyphicon glyphicon-tags"></span>  Date of Captivity </th>
                    <th style="text-align:center;"><span class="glyphicon glyphicon-phone"></span>  Images </th>
            ...
            <tbody id="tablebody">
               ...
               <tr class="success" style="cursor:pointer;">
                ...
                <td style="text-align:center;"><?php echo $row['physical_characteristics'];?></td>
                <td style="text-align:center;"><?php echo $row['date'];?></td>
                
                <td style="text-align:center;"><img src="<?php echo $row['dog_pictures']; ?>" class="img-thumbnail" alt="Dog Image" width="100px"></td>
